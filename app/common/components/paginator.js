//criando minha função auto invocada para colocar meu componente dentro dessa função para fugir do escopo global.
(function(){
        ...
        controller: [
            ...
            function($location){
                this.$onInit = function(){
                    ...
                    //este metodo vai dizer se um determinado elemento i é atual ou não
                }
